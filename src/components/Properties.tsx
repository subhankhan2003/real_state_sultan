...
export default function Properties() {
  const properties = [
    ...
    {
      id: 3,
      title: 'Commercial Plot in CAHAR BAGH',
      type: 'Plot',
      location: 'CAHAR BAGH, Lahore',
      area: '10 Marla',
      bedrooms: null,
      bathrooms: null,
      icon: MapPin,
    ...
    {
      id: 4,
      title: 'Residential House in BISMILLAH HOUSING SCHEME',
      type: 'House',
    ...
    {
      id: 6,
      title: 'Prime Plot in BAHRIA TOWN KARACHI',
      type: 'Plot',
